                  ...
                  <Paper elevation={0} sx={{ p: 2, borderRadius: 2, height: '100%' }}>
                    ...
                    {selectedDemand.RectorUser && (
                      <Box sx={{ 
                        ...
                        {/* Bursar Budget Information for Rector */}
                        {selectedDemand.BursarisApproved && selectedDemand.bursarBudgetInfo && (
                          <Box sx={{
                            p: 2,
                            mt: 2,
                    ...
                    {selectedDemand.ProcurementUser && (
                      <Box sx={{ 
                        ...
                        borderRadius: 2,
                        background: 'linear-gradient(145deg, rgba(255, 87, 34, 0.05), rgba(255, 138, 101, 0.1))',
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                          ...
                          <Box sx={{ flex: 1 }}>
                            <Typography variant="h6" sx={{ fontWeight: 'bold', color: '#FF5722' }}>
                              {selectedDemand.ProcurementUser.fullName}
                            </Typography>
                            ...
                            {selectedDemand.ProcurementcreatedAt && (
                              <Typography variant="caption" sx={{ 
                                ...
                                ✅ Processed: {new Date(selectedDemand.ProcurementcreatedAt).toLocaleString()}
                              </Typography>
                            )}
                          </Box>
                        </Box>

                        {/* Bursar Budget Information for Procurement */}
                        {selectedDemand.BursarisApproved && selectedDemand.bursarBudgetInfo && (
                          <Box sx={{
                            p: 2,
                            mt: 2,
